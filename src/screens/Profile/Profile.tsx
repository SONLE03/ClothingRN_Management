            ...
            <Modal visible={modalVisible} animationType="slide">
                ...
                <View className="p-4 flex-1 justify-center">
                    ...
                    <TouchableOpacity className='border border-orange-500 rounded-full h-28 w-28' onPress={pickImage}>
                        <Avatar.Image 
                            size={110} 
                            source={image ? { uri: image.uri } : user && user.image ? { uri: user.image } : require("../../assets/logo.png")} 
                        />
                        <IconButton 
                                icon="plus" 
                                size={15} 
                    ...
                    <Fumi className='border border-gray-500 rounded-xl mt-4'
                        ...
                        value={phone}
                    />
                    <View className="flex-col justify-center items-center p-2 h-12 w-full mb-4 mt-12">
                        <TouchableOpacity className='flex justify-center items-center bg-orange-500 rounded-xl w-3/4 h-12 mt-4' onPress={handleEditProfile}>
                            <Text className="text-lg font-semibold text-white">Save Changes</Text>
                        </TouchableOpacity>           
                        <TouchableOpacity className='flex justify-center items-center border border-orange-500 rounded-xl w-1/2 h-12 mt-4' onPress={() => setModalVisible(false)}>
