      ...
      <>
        <View className="bg-orange-500 h-10" style={styles.menuContainer}>
          <View style={styles.storeContainer}>
            ...
            />
            <Text className="text-xl font-bold text-white"> Furnistore</Text>
          </View>
            ...
            <Modal
              ...
              <View
                ...
                <View
                  ...
                  <Text className="text-lg mb-4 text-center p-1">
                    <Ionicons name="warning" size={30} color="#dd6b20" /> Are
            ...
            <View style={styles.infoContainer}>
              ...
              <View style={{flexDirection: 'column', justifyContent: 'center'}}>
                <View
                  ...
                  <Text style={[styles.textViewStyles, {fontSize: 18}]}>
        ...
        <View className="flex flex-row w-full justify-start items-center p-2 h-48 rounded-xl">
          <View
            className="bg-white mb-1 rounded-xl border border-gray-400"
            ...
            <View style={styles.textContainer}>
              <View
                ...
                <Text className="text-lg text-orange-600 font-semibold underline">
                  Order News
                </Text>
              </View>
              <TouchableOpacity
        ...
        <View className="flex flex-row w-full justify-start items-center p-2 h-[300] rounded-xl">
          <View
            className="bg-gray-50 mb-1 rounded-xl border border-gray-400"
            style={styles.functionContainer}>
            <Text className="text-lg text-orange-600 font-semibold underline text-center">
              Management Features
            </Text>
            <View style={styles.unitContainer}>
              <View style={styles.unitContainer}>
                <TouchableOpacity
                  className="flex justify-center items-center bg-white border border-orange-600 shadow-2xl rounded-xl w-24 h-20 p-2"
