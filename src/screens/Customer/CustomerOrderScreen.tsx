...
import { Orders, OrderDetail } from '../../types/Order';
import { GetOrderDetails } from '../../api/order/OrderDetails';
import HeaderBar from '../../components/HeaderBar';
import React, { useEffect, useState } from 'react';
import { View, Text, TouchableOpacity, Modal, ScrollView, Button, Image, SafeAreaView, FlatList } from 'react-native';
            ...
            <ScrollView className="p-4">
                {orders.length === 0 ? (
                    <View className="flex-1 justify-center items-center mt-20">
                        <Image source={require('../../assets/no-order.png')} style={{ width: 200, height: 200 }} />
