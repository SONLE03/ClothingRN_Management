...
const BranchScreen = ({navigation} : any) => {
    ...
    const filteredBranch = branches.filter(branches =>
        branches.name.toLowerCase().includes(searchText)
    );
    ...
    const handleAddBranch = () => {
        navigation.navigate("AddBranchScreen" as never)   
    }
      ...
      return (
        <SafeAreaView style={styles.container}>
            <TouchableOpacity style={styles.backButton}>
                ...
                <Text style={styles.backButtonText}>Branch List</Text>
            </TouchableOpacity>
            <View style={styles.InputContainerComponent}>
                ...
                <TextInput placeholder='Find your branches here...' 
                    value={searchText}
                    onChangeText={text => {
                    setSearchText(text);
                    }}
