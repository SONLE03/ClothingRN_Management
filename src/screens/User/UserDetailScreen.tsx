    ...
    <SafeAreaView className="flex-1 bg-gray-100 p-4">
        ...
        <View className="flex flex-col w-full p-2 border border-gray-400 rounded-xl h-24 bg-white mt-8">
          <View className="flex flex-row">
            <Text className="font-semibold text-lg text-gray-700">
              Email <Text className="text-red-500 font-semibold">*</Text>
            </Text>
          </View>
          <View style={{flex: 2, flexDirection: 'row'}}>
            <Text
              className="text-gray-700 border-b-gray-500 border border-x-white border-t-white mt-1 text-lg"
      ...
      <>
        <View className="flex flex-col w-full p-2 border border-gray-400 rounded-xl h-24 bg-white mt-8">
          <View className="flex flex-row">
            <Text className="font-semibold text-lg text-gray-700">
              Full name <Text className="text-red-500 font-semibold">*</Text>
            </Text>
          </View>
          <View style={{flex: 2, flexDirection: 'row'}}>
            <Text
      ...
      <>
        <View className="flex flex-col w-full p-2 border border-gray-400 rounded-xl h-24 bg-white mt-8">
          <View className="flex flex-row">
            <Text className="font-semibold text-lg text-gray-700">
              Phone <Text className="text-red-500 font-semibold">*</Text>
            </Text>
          </View>
          <View style={{flex: 2, flexDirection: 'row'}}>
            <Text
